                ...
                <div className="flex flex-col md:flex-row gap-12">
                    ...
                    <div className="left md:w-1/2">
                        <div className="md:absolute md:top-1/2 md:left-0 md:transform md:-translate-y-1/2">
                            ...
                            <p className="roboto text-xl md:text-2xl mt-4 mb-8 md:mb-9">Among the best Saudi chefs in the world, serving <br className="hidden md:block" /> you something beyond flavor.</p>
